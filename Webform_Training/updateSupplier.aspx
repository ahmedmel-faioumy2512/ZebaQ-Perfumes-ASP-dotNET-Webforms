<%@ Page Title="تعديل بيانات مورد" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="updateSupplier.aspx.cs" Inherits="Webform_Training.updateSupplier" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td class="centertext" colspan="3"><strong>تعديل بيانات مورد</strong></td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td>الكود</td>
            <td>
                <asp:TextBox ID="txtsuppID" runat="server" ReadOnly="True"></asp:TextBox>
            </td>
            <td>
