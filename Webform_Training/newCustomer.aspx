<%@ Page Title="اضافة عميل جديد" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="newCustomer.aspx.cs" Inherits="Webform_Training.newCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td class="centertext" colspan="3"><strong>عميل جديد</strong></td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="كود العميل مستخدم من قبل" ControlToValidate="txtCustID" ForeColor="#CC0000" OnServerValidate="CustomValidator1_ServerValidate" ValidationGroup="Save">*</asp:CustomValidator>
            </td>
        </tr>
        <tr>
            <td>الشركة</td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="اسم العميل موجود من قبل" ControlToValidate="txtContactName" ForeColor="#CC0000" OnServerValidate="CustomValidator2_ServerValidate" ValidationGroup="Save">*</asp:CustomValidator>
            </td>
        </tr>
        <tr>
            <td>اللقب</td>
