<%@ Page Title="فئات الاصناف" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ProCategories.aspx.cs" Inherits="Webform_Training.ProCategories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        <asp:View ID="View1" runat="server">
            <div class="row">
                <a href="newCategory.aspx" class="btn btn-primary">جديد</a>
            </div>
            <asp:GridView ID="grd" runat="server" Class="table table-striped table-hover" OnRowDataBound="grd_RowDataBound" OnRowDeleting="grd_RowDeleting">
                <Columns>
                    <asp:HyperLinkField DataNavigateUrlFields="CategoryID" DataNavigateUrlFormatString="updateCategory.aspx?id={0}" HeaderText="تعديل" Text="تعديل" />
