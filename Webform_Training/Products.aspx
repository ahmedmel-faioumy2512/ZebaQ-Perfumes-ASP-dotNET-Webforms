<%@ Page Title="الأصناف" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="Webform_Training.Products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        <asp:View ID="View1" runat="server">
            <div class="row">
                <a href="newProduct.aspx" class="btn btn-primary">جديد</a>
            </div>
            <asp:GridView ID="grd" runat="server" Class="table table-striped table-hover" OnRowDataBound="grd_RowDataBound" OnRowDeleting="grd_RowDeleting">
                <Columns>
                    <asp:HyperLinkField DataNavigateUrlFields="ProductID" DataNavigateUrlFormatString="updateProduct.aspx?id={0}" HeaderText="تعديل" Text="تعديل" />
